...
2. 展示 RAG Recall@K、MRR、Faithfulness。已展示 RAG Recall@5 基础指标
3. 展示 NL2SQL 执行准确率、安全违规率。已展示 SQL 校验率、表召回、过滤值召回
...
5. 输出 Recall@K / SQL 过滤值召回 / Memory Hit Rate。
6. 在 README 写入最新指标表。
...
| Phase 7.2 | 指标增强 | Memory Hit Rate、MRR、Faithfulness、执行准确率 | 待做 |
